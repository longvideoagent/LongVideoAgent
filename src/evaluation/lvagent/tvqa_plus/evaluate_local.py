...
DEFAULT_MODEL_DIR_TEMPLATE = "../videoagent-step-{checkpoint_step}"
DEFAULT_SUBS_PATH = "../Tvqa_data/all_episodes_subtitles_by_clips.json"
DEFAULT_QUESTIONS_PATH = "../Tvqa_data/tvqa_plus_val_sampled_300.json"
DEFAULT_BASE_FRAME_DIR = "../Tvqa_data/bbt_frames"
DEFAULT_OUTPUT_FILENAME_TEMPLATE = "./eval_videoagent-{checkpoint_step}.json"
