...
Using `scripts/quickstart_qwen_2_5_3B_grpo.sh` as an example, this page shows the full quickstart training configuration and key parameter notes.
...
GROUNDING_MODEL="grok-4-fast-non-reasoning"
...
ROLLOUT_LOG_PROB_MICRO_BSZ=1
REF_LOG_PROB_MICRO_BSZ=1
...
- `data.video_id_key`: The key name representing the video ID in datasets like LongTVQA (for example, `"vid_name"`).
